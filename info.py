...
BOT_TOKEN = environ.get('BOT_TOKEN', "6984531529:AAEymqwHseSLYVxqfN0M8vy6QCzk1LXcHK4")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/a5420771f0e9e2814feed.jpg')).split()#SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1134380825 5878008646 777060241').split()]
...
auth_channel = environ.get('AUTH_CHANNEL','-1001654996929')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://moviesuniverse:moviesu2@cluster0.ncowqhk.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://moviesuniverse2-9030175b9762.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviesuniverse2-9030175b9762.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviesuniverse2-9030175b9762.herokuapp.com/".format(FQDN)
else:
    URL = "https://moviesuniverse2-9030175b9762.herokuapp.com/".format(FQDN)
